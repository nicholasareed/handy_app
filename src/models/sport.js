define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        Sport = Backbone.DeepModel.extend({

            idAttribute: '_id',

            urlRoot: Credentials.server_root + "sport",
    ...
    Sport = Backbone.UniqueModel(Sport);

    var SportCollection = Backbone.Paginator.requestPager.extend({

            model: Sport,

            url: Credentials.server_root + "sports",
            urlRoot: Credentials.server_root + "sports",
