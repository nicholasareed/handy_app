define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        InvoiceItem = Backbone.DeepModel.extend({

            idAttribute: '_id',

            urlRoot: Credentials.server_root + "invoice_item/",
    ...
    InvoiceItem = Backbone.UniqueModel(InvoiceItem);

    var InvoiceItemCollection = Backbone.Paginator.requestPager.extend({

            model: InvoiceItem,

            // url: Credentials.server_root + "invoice_items/by_players",
            urlRoot: Credentials.server_root + "invoice_items/",
            ...
            findByLastInvoiceItem: function(){
