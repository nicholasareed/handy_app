define(function (require) {
    ...
    var $                   = require('jquery'),
        ...
        InvoiceContent = Backbone.DeepModel.extend({

            idAttribute: '_id',

            urlRoot: Credentials.server_root + "invoice_content/",
    ...
    InvoiceContent = Backbone.UniqueModel(InvoiceContent);

    var InvoiceContentCollection = Backbone.Paginator.requestPager.extend({

            model: InvoiceContent,

            // url: Credentials.server_root + "invoice_contents/by_players",
            urlRoot: Credentials.server_root + "invoice_contents/",
            ...
            initialize: function(models, options){
                ...
                if(options.invoice_id){
                  this.url = this.urlRoot + options.invoice_id;
                }
            ...
            findByLastInvoiceContent: function(){
    ...
    return {
        ...
        InvoiceContentCollection: InvoiceContentCollection
    };
