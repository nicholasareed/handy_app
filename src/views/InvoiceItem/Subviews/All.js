...
define(function(require, exports, module) {
    ...
    var tpl                 = require('text!./tpl/InvoiceItemTodo.html');
    ...
    SubView.prototype.loadModels = function(player_id){
        ...
        if(this.options.invoice_id){
            options['invoice_id'] = this.options.invoice_id;
        }

        this.collection = new InvoiceItemModel.InvoiceItemCollection([],options);
