...
define(function(require, exports, module) {
    ...
    var tpl                 = require('text!./tpl/EventStoryListItem.html');
    ...
    SubView.prototype.createAddBar = function() { 
        ...
        this.contentAddBar.AddText.Surface = new Surface({
            content: '<div class="outward-button with-icon"><i class="icon ion-ios7-photos"></i> <span>Add Text</span></div>',
            size: [undefined, undefined],
            classes: ['button-outwards-default']
        });
        this.contentAddBar.AddText.Surface.pipe(this._eventOutput);
        this.contentAddBar.AddText.Surface.on('click', function(event){
        ...
        this.contentAddBar.AddText = new View();
        this.contentAddBar.AddText.Surface = new Surface({
            content: '<div class="outward-button with-icon"><i class="icon ion-images"></i> <span>Add Photo</span></div>',
            size: [undefined, undefined],
            classes: ['button-outwards-default']
        });
        this.contentAddBar.AddText.Surface.pipe(this._eventOutput);
    ...
    SubView.prototype.uploadImage = function(imageURI){
        ...
        ft.upload(imageURI, Credentials.server_root + "/event/media", // no event_id needed, added it to the body
            function (e) {
                // getFeed();
                // alert('complete');
    ...
    SubView.prototype.addOne = function(Story) { 
        ...
        // console.log('Adding a Event Surface');
        // console.log(Event);
        ...
        switch(Story.get('type')){
            case 'text':
                ...
                storyView.Surface = new Surface({
                    ...
                    size: [undefined, 40],
                    classes: ['event-story-text-default']
                });
                ...
                storyView.Surface.on('click', function(){
                    ...
                    App.Cache.OptionModal = {
                        list: [
                            ...
                            {
                                text: 'Share Image and Link to Event',
                                value: 'share'
                            }
                        ],
                        on_choose: function(chosen_type){
                            ...
                            switch(chosen_type.value){
                                case 'view':
                                    ...
                                    break;
                                case 'share':
                                    window.plugins.socialsharing.share('',null,media.urls.original,'www.nemesisapp.net/event/public/' + Story.get('_id'));
                                    break;
                                default:
                                    break;
                            }
        ...
        //     content: '<div data-replace-id="'+Story.get('event_id')+'" data-replace-model="Player" data-replace-field="Profile.name">&nbsp;</div>',
        //     size: [undefined,undefined],
        //     properties: {
        ...
        //     App.history.navigate('event/' + Story.get('event_id')._id);
        // });
