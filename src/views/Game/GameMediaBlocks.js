...
define(function(require, exports, module) {
    ...
    function SubView(options) {
        ...
        // Expecting a game_id in here
        // - might be a promise that will eventually return a game_id on resolve
        if(typeof(options.game_id) === "object"){
            // Promise or array?
            // - fuckstick

            if(typeof options.game_id == typeof []){
                // array
                this.init_with_game(options.game_id);
                ...
                // After game_id resolves, display the Media
                options.game_id.then(this.init_with_game.bind(this));
            }
    ...
    SubView.prototype.init_with_game = function(player_id){
        var that = this;
