...
define(function(require, exports, module) {
    ...
    StandardTabBar.prototype = Object.create(View.prototype);
    StandardTabBar.prototype.constructor = StandardTabBar;

    StandardTabBar.DEFAULT_OPTIONS = {
        sections: [],
        widget: StandardToggleButton,
        size: [undefined, 50],
        direction: Utility.Direction.X,
        buttons: {
            toggleMode: StandardToggleButton.ON
        }
    };
     ...
     */
    StandardTabBar.prototype.defineSection = function defineSection(id, content) {
        var button;
     ...
     */
    StandardTabBar.prototype.select = function select(id, triggerEvent) {
        ...
        if (this.buttons[btn] && this.buttons[btn].isSelected()) {
            ...
            this.buttons[btn].select(triggerEvent); // modified StandardToggleButton
        }
