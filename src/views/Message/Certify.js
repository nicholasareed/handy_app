...
define(function(require, exports, module) {
    ...
    SubView.prototype.addOne = function(Game) { 
        ...
        Game.on('change', function(){
            ...
            switch(certified){
                case null:
                    content = Game.get('sport_id.name') + ': (tap to certify)';
                    classes = ['certify-game-default', 'certify-game-null'];
                    break;
                case true:
                    content = Game.get('sport_id.name') + ': Certified!';
                    classes = ['certify-game-default', 'certify-game-ok'];
                    break;
                case false:
                    content = Game.get('sport_id.name') + ': Disputed!';
                    classes = ['certify-game-default', 'certify-game-disputed'];
                    break;
                case undefined:
                default:
