...
GeolocationMarker.prototype.newPosition_ = function(position) {
  this.updatePosition_(position);
};

GeolocationMarker.prototype.newAccuracy_ = function(accuracy) {
  // this.updatePosition_(position);
  google.maps.MVCObject.prototype.set.call(this, 'accuracy', accuracy);
};

GeolocationMarker.prototype.newClickPosition_ = function(latLng) {
  google.maps.MVCObject.prototype.set.call(this, 'position', latLng);
};
